...
results = Dict(
    ...
    "RDL" => Dict{String,Dict{Int,Vector{Float64}}}(),
)

for dataset in DATASETS
    for (mtype, sizes) in [("RF", RF_SIZES), ("XGBoost", XGBOOST_SIZES), ("RDL", RDL_SIZES)]
...
#  # MODEL: RF
#  # ==============================
#  # dataset   n_trees   seed1_acc   seed2_acc ... seed10_acc   mean_acc   std_acc
#  car         2         0.91        0.89       ...             0.903      0.012
#  ...
#
#  (repeated for XGBoost and RDL)
# ============================================================
